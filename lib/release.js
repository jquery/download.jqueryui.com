var _ = require( "underscore" ),
	...
	commonFiles, componentFiles, filesCache = {};
...
// Default is the first jqueryUi object in the config file explicitly declared default by { "default": "true" }, or the first element of the Array if no one is explicitly declared.
Release.getDefault = function() {
	if ( !Release._default ) {
		Release._default = Release.all().filter(function( release ) {
			return release.isDefault;
		})[ 0 ] || Release.all()[ 0 ];
	}
	return Release._default;
};
