...
function ThemeRoller( vars ) {
	...
	opacityFix = function( opacity ) {
		return /* w3c */ ( opacity / 100 ).toString() + /* IE */ ";filter:Alpha(Opacity=" + opacity + ")";
	};
...
ThemeRoller.prototype = {
	...
	url: function() {
		var querystring;
		if ( this.zThemeParams.length && this.zThemeParams.length + "zThemeParams=".length < this.serializedVars.length ) {
