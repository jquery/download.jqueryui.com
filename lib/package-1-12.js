...
extend( Package.prototype, {
	"external/jquery/jquery.js": "external/jquery/jquery.js",
	...
	"jquery-ui.theme.css": function( callback ) {
		...
		jqueryCssBuilder( this.files, "theme", {
			appDir: "ui",
			include: this.runtime.components,
			onCssBuildWrite: function( _path, data ) {
				themeCssFileNames.push( path.basename( _path ) );
				return data;
			},
			paths: {
				jquery: "../external/jquery/jquery"
			...
			self.themeroller = themeroller = new ThemeRoller( baseThemeCss, runtime.themeVars );
			self.customThemeUrl = themeroller.url();
			css = themeroller.css();
			...
			themeCss.resolve( stripBanner( css ) );
			callback( null, css );
		});
	},
