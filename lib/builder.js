...
function Builder( jqueryUi, components, options ) {
	...
	if ( components.indexOf( "datepicker" ) >= 0 ) {
		...
		this.bundleI18n = JqueryUi.files({
		...
		this.bundleI18nMin = JqueryUi.files({
		...
		this.i18nFiles = this.i18nMinFiles = this.bundleI18n = this.bundleI18nMin = JqueryUi.files();
	}
	...
	this.bundleJsMin = JqueryUi.files({
